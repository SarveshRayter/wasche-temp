...
def search_user(request):
    ...
    if u["res"]==True:
        if u["p"]==False:
            noti = Notifications(type_msg = "tracking",email = u["u"],sent_from = "Admin",title = "Wrong Order",msg="We received order for the plan expired.",seen=False)
            noti.save()
            # onsignal("Your order has been recieved at our warehouse. You can track the order details in tracking page.",u)
            onsignal("We received order for the plan expired.",u["u"])
